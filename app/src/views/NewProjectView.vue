...
const form = reactive({
  title: '',
  category: 'Bug' as ProjectCategory,
  content: '',
  image: '',
  ...
  <main class="new-project-view">
    ...
    <section class="form-panel">
      ...
      <form class="project-form" @submit.prevent="createProject">
        ...
        <div class="form-field">
          <label for="image">画像URL（任意）</label>
          <input
            id="image"
            v-model="form.image"
            name="image"
...
.form-panel {
  ...
  background: linear-gradient(145deg, rgba(16, 36, 60, 0.96), rgba(9, 24, 43, 0.98)), #0c1b30;
  box-shadow:
...
:global(body:has(.new-project-view) #vue-inspector-container),
:global(body:has(.new-project-view) #__vue-devtools-container__) {
